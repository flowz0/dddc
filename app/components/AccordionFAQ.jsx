...
export default function AccordionFAQ() {
	...
	return (
		<Accordion selectionMode="multiple" defaultExpandedKeys={["2"]} showDivider={false} className="text-[#333333] flex flex-col gap-y-4" itemClasses={itemClasses}>
			<AccordionItem key="1" aria-label="How often should air ducts be cleaned?" title="How often should air ducts be cleaned?">
				{answer}
			</AccordionItem>
			...
			<AccordionItem key="4" aria-label="How much is air duct cleaning?" title="How much is air duct cleaning?">
				{answer4}
			</AccordionItem>
			<AccordionItem key="5" aria-label="What are the benefits of air duct cleaning?" title="What are the benefits of air duct cleaning?">
				{answer5}
			</AccordionItem>
		</Accordion>
	)
