...
export default function Service({ serviceImage, serviceTitle, serviceDesc, serviceCTAButton }) {
    return (
        <article className="max-w-4xl md:max-w-xl lg:max-w-sm max-h-full bg-[#F5F5F7] md:border md:border-gray-200 md:rounded-lg sm:shadow-md dark:bg-gray-800 dark:border-gray-700">
            <Image
            ...
            <header className="p-2 sm:p-6 pt-4">
                ...
                <p className="mt-2 font-medium tracking-tight text-[rgba(51,51,51,0.85)] dark:text-gray-400">
                    {serviceDesc}
                </p>
                <Button className="mt-4 bg-[#3A73BA] text-[#F5F5F7]" radius="lg"
                    endContent={
